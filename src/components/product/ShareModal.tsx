          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              onClick={() => {
                ...
                const text = `Check out ${productName} on GifteeCo! ${url}`;
                window.open(
            ...
            <button
              onClick={() => {
                ...
                onClose();
                toast.info("Copy the product link to share on Instagram");
              }}
              className="flex items-center gap-3 px-4 py-3 rounded-lg border border-neutral-200 hover:bg-neutral-50 transition"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => {
                const url = `${window.location.origin}/product/${productId}`;
                const text = `Check out ${productName} on GifteeCo!`;
                window.open(
            ...
            >
              ...
              <span className="text-sm text-neutral-700">X (Twitter)</span>
            </button>
